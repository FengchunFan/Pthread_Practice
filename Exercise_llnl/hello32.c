...
* OBSERVATION: 32 threads will be created, the order of the display is totally random
               this is the nature of thread unless we perform explicit synchronization (mutex etc.)
               the order is solely depend on the OS's scheduling algorithm
               two instances of pthread_exit(), similar purpose as return 0
******************************************************************************/
#include <pthread.h>
#include <stdio.h>
#include <stdlib.h>
